...
switch (isset($_GET['mode']) ? $_GET['mode'] : null) {
    case 'crear':
        ...
        if (isset($_POST['general'])) {
            ...
            // require('core/models/administrador/datos/class.asignarFuncionarioActividadMD.php');
            // echo json_encode(asignarFuncionarioMD::crear());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
            include('html/administrador/datos/asignacionFuncionariosCapacitacionesProgramadasVW.php');
        }
        break;
        include('html/administrador/overall/headerVW.php');
