...
switch (isset($_GET['mode']) ? $_GET['mode'] : null) {
    case 'crear':
        ...
        if (isset($_POST['general'])) {
            ...
            require('core/models/administrador/datos/class.capacitacionesProgramadasMD.php');
            echo json_encode(capacitacionProgramadaMD::crear());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
            include('html/administrador/datos/capacitacionesProgramadasVW.php');
        }
        break;
    case 'modificar':
        include('core/bin/functions/conexion.php');
        if (isset($_POST['general'])) {
            ...
            include('core/bin/functions/class.logger.php');
            require('core/models/administrador/datos/class.capacitacionesProgramadasMD.php');
            echo json_encode(capacitacionProgramadaMD::modificar());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
    ...
    case 'eliminar':
        ...
        if (isset($_POST['general'])) {
            ...
            include('core/bin/functions/class.logger.php');
            require('core/models/administrador/datos/class.capacitacionesProgramadasMD.php');
            echo json_encode(capacitacionProgramadaMD::eliminar());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
    ...
    case 'trazabilidad':
        ...
        if (isset($_POST['general'])) {
            ...
            include('core/bin/functions/class.logger.php');
            require('core/models/administrador/datos/class.capacitacionesProgramadasMD.php');
            echo json_encode(capacitacionProgramadaMD::trazabilidad());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
