...
switch (isset($_GET['mode']) ? $_GET['mode'] : null) {
    case 'crear':
        ...
        if (isset($_POST['general'])) {
            ...
            require('core/models/administrador/datos/class.matrizMD.php');
            echo json_encode(matrizMD::crear());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
            include('html/administrador/datos/crearMatrizVW.php');
        }
        break;
    case 'modificar':
        include('core/bin/functions/conexion.php');
        if (isset($_POST['general'])) {
            ...
            include('core/bin/functions/class.logger.php');
            require('core/models/administrador/datos/class.matrizMD.php');
            echo json_encode(matrizMD::modificar());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
            include('html/administrador/datos/matrizModificarVW.php');
        }
        break;
    case 'eliminar':
        include('core/bin/functions/conexion.php');
        if (isset($_POST['general'])) {
            ...
            include('core/bin/functions/class.logger.php');
            require('core/models/administrador/datos/class.matrizMD.php');
            echo json_encode(matrizMD::eliminar());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
    ...
    case 'trazabilidad':
        ...
        if (isset($_POST['general'])) {
            ...
            include('core/bin/functions/class.logger.php');
            require('core/models/administrador/datos/class.matrizMD.php');
            echo json_encode(matrizMD::trazabilidad());
            exit();
        } else {
            // include('core/models/generics/class.getClasificacionTribuMD.php');
            include('html/administrador/overall/headerVW.php');
