...
switch (isset($_GET['mode']) ? $_GET['mode'] : null) {
  case 'crear':
    ...
    if (isset($_POST['id_funcionario'])) {
      ...
      require('core/models/administrador/datos/class.retiroMD.php');
      echo json_encode(retiroMD::crear());
      exit();
    } else {
      // include('core/models/generics/class.getClasificacionTribuMD.php');
      include('html/administrador/overall/headerVW.php');
      include('html/administrador/datos/retiroVW.php');
    }
    break;
  case 'eliminar':
    include('core/bin/functions/conexion.php');
    if (isset($_POST['id_retiro'])) {
      ...
      include('core/bin/functions/class.logger.php');
      require('core/models/administrador/datos/class.retiroMD.php');
      echo json_encode(retiroMD::eliminar());
      exit();
    } else {
      // include('core/models/generics/class.getClasificacionTribuMD.php');
      include('html/administrador/overall/headerVW.php');
