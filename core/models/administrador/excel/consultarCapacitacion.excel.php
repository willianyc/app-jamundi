...
if (true) {
  ...
  $data = generalesMD::getListadoCapacitaciones();
  ...
  foreach ($data as $capacitaciones) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('F' . $fila, $capacitaciones['entidadCapacitadora']);
    $objPHPExcel->getActiveSheet()->setCellValue('G' . $fila, $capacitaciones['asistentes']);
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, $capacitaciones['estado']);
    $objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, $capacitaciones['conocimiento_previo']);
    $objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, $capacitaciones['horas_formativas']);
    $fila++;
  }
