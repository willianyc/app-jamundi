...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('B1', "DEPENDENCIA");
  ...
  foreach ($data as $capacitaciones) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $fila, $capacitaciones['dependencia']);
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, $capacitaciones['modalidad']);
  ...
  header('Content-Disposition: attachment;filename="consultarInspecciones.xls"');
