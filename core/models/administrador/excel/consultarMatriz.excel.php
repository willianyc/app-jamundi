...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('B1', "ORIGEN HALLAZGO");
  $objPHPExcel->getActiveSheet()->setCellValue('C1', "DESCRIPCIÓN HALLAZGO");
  $objPHPExcel->getActiveSheet()->setCellValue('D1', "RESPONSABLE");
  $objPHPExcel->getActiveSheet()->setCellValue('E1', "ACCIÓN TOMADA");
  ...
  foreach ($data as $capacitaciones) {
    $objPHPExcel->getActiveSheet()->setCellValue('A' . $fila, $capacitaciones['id_matriz']);
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $fila, $capacitaciones['origen_hallazgo']);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $fila, $capacitaciones['descripcion_hallazgo']);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, $capacitaciones['responsable']);
    $objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, $capacitaciones['accion_tomada']);
  ...
  header('Content-Disposition: attachment;filename="matrizDeCumplimiento.xls"');
