...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('C1', "ACTIVIDADES");
  ...
  foreach ($data as $actividades) {
    $objPHPExcel->getActiveSheet()->setCellValue('A' . $fila, $actividades['documento']);
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $fila, $actividades['nombre']);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $fila, $actividades['actividades']);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, $actividades['participaciones']);
  ...
  header('Content-Disposition: attachment;filename="RankingActividades.xls"');
