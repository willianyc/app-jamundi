...
if (true) {
  ...
  $data = generalesMD::getCapacitacionesProgramadasAsignacionExcel($_GET['id_capacitacion']);
  ...
  header('Content-Disposition: attachment;filename="capacitacionProgramada.xls"');
