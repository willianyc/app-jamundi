...
if (true) {
  ...
  //$data = generalesMD::getActividades();
  $data = generalesMD::getActividad1_2($_GET['fecha_ini'],$_GET['fecha_fin']);
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('F1', "MODALIDAD");
  $objPHPExcel->getActiveSheet()->setCellValue('G1', "DIRECCIÓN");
  $objPHPExcel->getActiveSheet()->setCellValue('H1', "HORAS FORMATIVAS");
  $objPHPExcel->getActiveSheet()->setCellValue('I1', "ENTIDAD REALIZADORA");
  ...
  foreach ($data as $actividad) {
    $objPHPExcel->getActiveSheet()->setCellValue('A' . $fila, $actividad['identificacion']);
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $fila, $actividad['nombre']);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $fila, $actividad['fecha_ini']);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, $actividad['fecha_fin']);
    $objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, $actividad['estado']);
    $objPHPExcel->getActiveSheet()->setCellValue('F' . $fila, $actividad['is_presencial']);
    $objPHPExcel->getActiveSheet()->setCellValue('G' . $fila, $actividad['direccion']);
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, $actividad['horas_formativas']);
    $objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, $actividad['entidad_actividad']);
    $fila++;
  }
