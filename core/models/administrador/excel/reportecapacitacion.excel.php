...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('E1', "CANTIDAD DE ASISTENTES");
  ...
  foreach ($data as $funcionario) {
    $objPHPExcel->getActiveSheet()->setCellValue('A' . $fila, $funcionario['indentificacion']);
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $fila, $funcionario['nombre']);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $fila, $funcionario['fecha_ini']);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $fila, $funcionario['fecha_fin']);
    $objPHPExcel->getActiveSheet()->setCellValue('E' . $fila, $funcionario['cantidad']);
    $fila++;
  }

  $objPHPExcel->getActiveSheet()->setSharedStyle($estiloTituloColumnas, "A1:E1");
