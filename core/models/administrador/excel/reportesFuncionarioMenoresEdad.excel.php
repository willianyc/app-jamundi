...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('H1', "NOMBRE HIJO");
  $objPHPExcel->getActiveSheet()->setCellValue('I1', "NACIMIENTO");
  $objPHPExcel->getActiveSheet()->setCellValue('J1', "EDAD");
  ...
  foreach ($data as $funcionario) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, $funcionario['nombre_hijo']);
    $objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, $funcionario['nacimiento_hijo']);
    $objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, $funcionario['edad_hijo']);
  ...
  header('Content-Disposition: attachment;filename="FuncionarioHijosMenores.xls"');
