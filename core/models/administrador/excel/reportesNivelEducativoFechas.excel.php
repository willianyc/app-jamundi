...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('H1', "NIVEL EDUCATIVO");
  ...
  foreach ($data as $funcionario) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, $funcionario['nivel_educativo']);
  ...
  header('Content-Disposition: attachment;filename="FuncionarioNivelEducativoFechas.xls"');
