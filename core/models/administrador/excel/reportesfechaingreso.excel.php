...
if (true) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('H1', "FECHA DE INGRESO");
  ...
  foreach ($data as $funcionario) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('H' . $fila, $funcionario['fecha_ingreso_nombra']);
    $objPHPExcel->getActiveSheet()->setCellValue('I' . $fila, $funcionario['is_activo']==1?"Activo":"Retirado");
 /*   $objPHPExcel->getActiveSheet()->setCellValue('J' . $fila, $funcionario['']);
    $objPHPExcel->getActiveSheet()->setCellValue('K' . $fila, $funcionario['']);
