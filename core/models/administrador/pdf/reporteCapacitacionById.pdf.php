...
if (true) {
  ...
  class PDF extends FPDF_dd
  {
    ...
    function header()
    {
      ...
      $this->Cell(0, 10, utf8_decode('REPORTE CAPACITACION PDF '), 0, 0, 'C');
    ...
    function tableTotal($data)
    {
      ...
      $this->Cell(260, 5, utf8_encode('CAPACITACION'), 1, 0, 'C', true);
      $this->Ln();
      $this->SetFont('Arial', 'b', 8);
      $this->Cell(10, 5, utf8_decode('#'), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode('Identificación'), 1, 0, 'C', true);
      $this->Cell(50, 5, utf8_decode('Nombre'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('Fecha Inicio'), 1, 0, 'C', true);
      $this->Cell(35, 5, utf8_decode('Fecha Fin'), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode('Modalidad'), 1, 0, 'C', true);
      $this->Cell(30, 5, utf8_decode('Lugar'), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode('Estado'), 1, 0, 'C', true);
      $this->Cell(15, 5, utf8_decode('Cantidad'), 1, 0, 'C', true);
      $this->Ln(5);
      $this->Cell(10, 5, utf8_decode(1), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode($data['identificacion']), 1, 0, 'C', true);
      $this->Cell(50, 5, utf8_decode($data['nombre']), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode($data['fecha_ini']), 1, 0, 'C', true);
      $this->Cell(35, 5, utf8_decode($data['fecha_fin']), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode($data['is_presencial']), 1, 0, 'C', true);
      $this->Cell(30, 5, utf8_decode($data['direccion']), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode($data['estado']), 1, 0, 'C', true);
      $this->Cell(15, 5, utf8_decode(count($data['cantidad'])), 1, 0, 'C', true);
      $this->Ln(5);
