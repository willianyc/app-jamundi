...
if (true) {
  ...
  $data = generalesMD::getActividadesProgramadas();
  ...
  class PDF extends FPDF_dd
  {
    ...
    function body($data)
    {
      ...
      $this->SetFillColor(224, 235, 255);
      $this->Cell(260, 5, utf8_encode('REPORTE DE ACTIVIDADES PROGRAMADAS '), 1, 0, 'C', true);
      $this->Ln();
      ...
      $this->Cell(20, 5, utf8_decode('Recursos'), 1, 0, 'C', true);
      ...
      foreach ($data as $key => $row){
        ...
        $this->Cell(35, 5, utf8_decode($row['nombre']), 1, 0, 'C', true);
        ...
        $this->Cell(50, 5, utf8_decode($row['entidad_actividad']), 1, 0, 'C', true);
        $this->Cell(20, 5, utf8_decode($row['recursos']), 1, 0, 'C', true);
