...
if (true) {
  ...
  class PDF extends FPDF_dd
  {
    ...
    function body($data)
    {
      ...
      $this->SetFillColor(224, 235, 255);
      $this->Cell(260, 5, utf8_encode('REPORTE MATRIZ DE CUMPLIMIENTO '), 1, 0, 'C', true);
      $this->Ln();
      $this->SetFont('Arial', 'b', 8);
      $this->Cell(10, 5, utf8_decode('#'), 1, 0, 'C', true);
      $this->Cell(20, 5, utf8_decode('Lugar'), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode('Fecha'), 1, 0, 'C', true);
      $this->Cell(35, 5, utf8_decode('Origen Hallazgo'), 1, 0, 'C', true);
      $this->Cell(40, 5, utf8_decode('Descripción Hallazgo'), 1, 0, 'C', true);
      $this->Cell(30, 5, utf8_decode('Elemento Interviene'), 1, 0, 'C', true);
      $this->Cell(50, 5, utf8_decode('Responsable'), 1, 0, 'C', true);
      $this->Cell(20, 5, utf8_decode('Acción Tomada'), 1, 0, 'C', true);
      ...
      foreach ($data as $key => $row){
        ...
        $this->Cell(20, 5, utf8_decode($row['lugar']), 1, 0, 'C', true);
        $this->Cell(25, 5, utf8_decode($row['fecha']), 1, 0, 'C', true);
        $this->Cell(35, 5, utf8_decode($row['origen_hallazgo']), 1, 0, 'C', true);
        $this->Cell(40, 5, utf8_decode($row['descripcion_hallazgo']), 1, 0, 'C', true);
        $this->Cell(30, 5, utf8_decode($row['elemento_interviene']), 1, 0, 'C', true);
        $this->Cell(50, 5, utf8_decode($row['responsable']), 1, 0, 'C', true);
        $this->Cell(20, 5, utf8_decode($row['accion_tomada']), 1, 0, 'C', true);
