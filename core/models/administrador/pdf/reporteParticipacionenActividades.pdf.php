...
if (true) {
  ...
  $data = generalesMD::ParticipacionesenActividades($_GET['fecha_ini'], $_GET['fecha_fin']);
  // if (!empty($_GET['mes']))
  ...
  class PDF extends FPDF_dd
  {
    ...
    function tableTotal($data)
    {
      ...
      $this->Cell(180, 5, utf8_encode('PARTICIPACION DE FUNCIONARIOS EN ACTIVIDADES ENTRE LAS FECHAS : '. $_GET['fecha_ini'] .' Y '. $_GET['fecha_fin']), 1, 0, 'C', true);
      $this->Ln();
  ...
  $name_file = 'participacionenActividades' . time() . '.pdf';
