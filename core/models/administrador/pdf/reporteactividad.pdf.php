...
if (true) {
  ...
  class PDF extends FPDF_dd
  {
    ...
    function header()
    {
      ...
      $this->Cell(0, 10, utf8_decode('REPORTE ACTIVIDADES PDF '), 0, 0, 'C');
      $this->SetTextColor('0', '0', '0');
      $this->Ln(6);
    ...
    function tableTotal($data)
    {
     ...
     // $this->Ln(4);
      ...
      $this->Cell(260, 5, utf8_encode('REPORTE DE ACTIVIDADES ENTRE LAS FECHAS : '. $_GET['fecha_ini'] .' Y '. $_GET['fecha_fin']), 1, 0, 'C', true);
      $this->Ln();
      ...
      $this->Cell(30, 5, utf8_decode('Fecha Inicio'), 1, 0, 'C', true);
      ...
      $this->Cell(45, 5, utf8_decode('Entidad'), 1, 0, 'C', true);
      $this->Cell(20, 5, utf8_decode('Cantidad'), 1, 0, 'C', true);
          $this->SetFillColor(255, 255, 255);
      $this->Ln(5);
      foreach ($data as $key => $row) {
        $this->Cell(10, 5, utf8_decode($key+1), 1, 0, 'C', true);
        $this->Cell(30, 5, utf8_decode($row['identificacion']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($row['nombre']), 1, 0, 'C', true);
        $this->Cell(30, 5, utf8_decode($row['fecha_ini']), 1, 0, 'C', true);
        $this->Cell(25, 5, utf8_decode($row['estado']), 1, 0, 'C', true);
        $this->Cell(25, 5, utf8_decode($row['is_presencial']), 1, 0, 'C', true);
        $this->Cell(30, 5, utf8_decode($row['direccion']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($row['entidad_actividad']), 1, 0, 'C', true);
        $this->Cell(20, 5, utf8_decode($row['cantidad']), 1, 0, 'C', true);
        $this->Ln(5);
      }
