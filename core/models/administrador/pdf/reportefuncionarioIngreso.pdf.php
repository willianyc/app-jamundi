...
if (true) {
  ...
  if (!empty($_GET['fecha_ini']) && !empty($_GET['fecha_fin']))
    $data = generalesMD::Funcionario_fechaIni($_GET['fecha_ini'], $_GET['fecha_fin']);
  ...
  class PDF extends FPDF_dd
  {
    ...
    function tableTotal($data)
    {
     ...
     // $this->Cell(1170, 5, utf8_encode('Reporte de Funcionarios por Fechas de ingreso entre : '. $_GET['fecha_ini'] .' y '. $_GET['fecha_fin']), 1, 0, 'C', true);
       $this->Cell(280, 10, utf8_encode('REPORTE DE FUNCIONARIOS POR FECHAS DE INGRESO ENTRE: '. $_GET['fecha_ini'] .' y '. $_GET['fecha_fin']), 1, 0, 'C', true);
	  $this->Ln();
     ...
     // $this->Cell(45, 5, utf8_decode('GRADO'), 1, 0, 'C', true);
      ...
      $this->Cell(30, 5, utf8_decode('FECHA DE INGRESO'), 1, 0, 'C', true);
	   $this->Cell(20, 5, utf8_decode('ESTADO'), 1, 0, 'C', true);
     ...
     // $this->Cell(45, 5, utf8_decode('CONDICION MEDICA'), 1, 0, 'C', true);
      ...
      //  $this->Cell(45, 5, utf8_decode($funcionario['grado']), 1, 0, 'C', true);
        ...
        $this->Cell(30, 5, utf8_decode($funcionario['fecha_ingreso_nombra']), 1, 0, 'C', true);
		 $this->Cell(20, 5, utf8_decode($funcionario['is_activo']==1?"Activo":"Retirado"), 1, 0, 'C', true);
  ...
  $name_file = 'funcionarios' . $_GET['fecha_ini'] . '_' . $_GET['fecha_fin'] . '.pdf';
