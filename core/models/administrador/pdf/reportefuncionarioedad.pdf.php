  ...
  class PDF extends FPDF_dd
  {
     ...
     function tableTotal($data)
    {
     ...
     // $this->Cell(1170, 5, utf8_encode('Reporte de Funcionarios por Fechas de ingreso entre : '. $_GET['fecha_ini'] .' y '. $_GET['fecha_fin']), 1, 0, 'C', true);
       $this->Cell(280, 10, utf8_encode('REPORTE DE FUNCIONARIOS POR EDAD ENTRE: '. $_GET['edad_ini'] .' y '. $_GET['edad_fin']), 1, 0, 'C', true);
	  $this->Ln();
      $this->SetFont('Arial', 'b', 8);
	  $this->Cell(10, 5, utf8_decode('N'), 1, 0, 'C', true);
      $this->Cell(30, 5, utf8_decode('IDENTIFICACION'), 1, 0, 'C', true);
      $this->Cell(40, 5, utf8_decode('NOMBRES'), 1, 0, 'C', true);
      $this->Cell(20, 5, utf8_decode('GENERO'), 1, 0, 'C', true);
     ...
     // $this->Cell(45, 5, utf8_decode('GRADO'), 1, 0, 'C', true);
      ...
      $this->Cell(30, 5, utf8_decode('NACIMIENTO'), 1, 0, 'C', true);
     ...
     // $this->Cell(45, 5, utf8_decode('CONDICION MEDICA'), 1, 0, 'C', true);
	  ...
	  $this->SetFillColor(255, 255, 255);
        ...
        $this->Cell(40, 5, utf8_decode($funcionario['nombre'].' '.$funcionario['apellidos']), 1, 0, 'C', true);
        $this->Cell(20, 5, utf8_decode($funcionario['genero']), 1, 0, 'C', true);
      ...
      //  $this->Cell(45, 5, utf8_decode($funcionario['grado']), 1, 0, 'C', true);
        ...
        $this->Cell(30, 5, utf8_decode($funcionario['fecha_nacimiento']), 1, 0, 'C', true);
		 $this->Cell(20, 5, utf8_decode($funcionario['edad']), 1, 0, 'C', true);
