...
if (true) {
  ...
  class PDF extends FPDF_dd
  {
    ...
    function header()
    {
      ...
      $this->Cell(0, 10, utf8_decode('REPORTE INCAPACIDAD PDF'), 0, 0, 'C');
    ...
    function tableTotal($data)
    {
      ...
      $this->Cell(315, 5, utf8_encode('Detalles Incapacidad'), 1, 0, 'C', true);
      $this->Ln();
      $this->SetFont('Arial', 'b', 8);
      $this->Cell(45, 5, utf8_decode('IDENTIFICACION'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('NOMBRES'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('TIPO INCAPACIDAD'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('DIAGNOSTICO'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('DIAS'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('FECHA INICIO'), 1, 0, 'C', true);
      $this->Cell(45, 5, utf8_decode('FECHA FINALIZACION'), 1, 0, 'C', true);
      $this->Ln(5);
      foreach ($data as $key => $incapacidad) {
        $this->Cell(45, 5, utf8_decode($incapacidad['documento']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($incapacidad['nombre'] . ' ' . $incapacidad['apellidos']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($incapacidad['tipo_incapacidad']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($incapacidad['diagnostico']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($incapacidad['dias']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($incapacidad['fecha_ini']), 1, 0, 'C', true);
        $this->Cell(45, 5, utf8_decode($incapacidad['fecha_fin']), 1, 0, 'C', true);
        $this->Ln(5);
      }
  ...
  $name_file = 'Incapacidad' . time() . '.pdf';
