...
if (true) {
  ...
  $data = generalesMD::rankingFuncionariosActividades($_GET['fecha_ini'], $_GET['fecha_fin']);
  // if (!empty($_GET['mes']))
  ...
  class PDF extends FPDF_dd
  {
    ...
    function tableTotal($data)
    {
      ...
      $this->Cell(320, 5, utf8_encode('RANKING DE ACTIVIDADES ENTRE LAS FECHAS : '. $_GET['fecha_ini'] .' Y '. $_GET['fecha_fin']), 1, 0, 'C', true);
      $this->Ln();
      $this->SetFont('Arial', 'b', 8);
      $this->Cell(10, 5, utf8_decode('#'), 1, 0, 'C', true);
      $this->Cell(40, 5, utf8_decode('Documento'), 1, 0, 'C', true);
      $this->Cell(80, 5, utf8_decode('Nombre'), 1, 0, 'C', true);
      $this->Cell(30, 5, utf8_decode('N.Actividades'), 1, 0, 'C', true);
      
      $this->Cell(160, 5, utf8_decode('Participaciones'), 1, 0, 'C', true);
      ...
      foreach ($data as $key => $row) {
        ...
        $this->Cell(40, 5, utf8_decode($row['documento']), 1, 0, 'C', true);
        $this->Cell(80, 5, utf8_decode($row['nombre']), 1, 0, 'C', true);
        $this->Cell(30, 5, utf8_decode($row['actividades']), 1, 0, 'C', true);
        $this->Cell(160, 5, utf8_decode($row['participaciones']), 1, 0, 'C', true);
  ...
  $name_file = 'rankingCapacitaciones' . time() . '.pdf';
