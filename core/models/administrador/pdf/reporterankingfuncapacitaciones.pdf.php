...
if (true) {
  ...
  class PDF extends FPDF_dd
  {
    ...
    function tableTotal($data)
    {
      ...
      $this->Cell(320, 5, utf8_encode('RANKING DE CAPACITACIONES ENTRE LAS FECHAS : '. $_GET['fecha_ini'] .' Y '. $_GET['fecha_fin']), 1, 0, 'C', true);
      $this->Ln();
      ...
      $this->Cell(30, 5, utf8_decode('N.Capacitaciones'), 1, 0, 'C', true);
      ...
      foreach ($data as $key => $row) {
        ...
        $this->Cell(30, 5, utf8_decode($row['capacitaciones']), 1, 0, 'C', true);
