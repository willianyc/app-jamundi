...
if (true) {
  ...
  $data = generalesMD::getFuncionarioNivelEducativoNuevo($_GET['nivel_educativo'],$_GET['fecha_ini'], $_GET['fecha_fin']);
...
//$this->Ln();
     ...
     // $this->Cell(1170, 5, utf8_encode('Reporte de Funcionarios por Fechas de ingreso entre : '. $_GET['fecha_ini'] .' y '. $_GET['fecha_fin']), 1, 0, 'C', true);
       $this->Cell(280, 10, utf8_encode('REPORTE DE FUNCIONARIOS POR NIVEL EDUCATIVO: '. $_GET['nivel_educativo']. ' ENTRE LAS FECHAS: '. $_GET['fecha_ini'] .' Y '. $_GET['fecha_fin']), 1, 0, 'C', true);
	  $this->Ln();
     ...
     // $this->Cell(45, 5, utf8_decode('GRADO'), 1, 0, 'C', true);
	  ...
	  $this->Cell(40, 5, utf8_decode('NIVEL EDUCATIVO'), 1, 0, 'C', true);
     ...
     // $this->Cell(45, 5, utf8_decode('CONDICION MEDICA'), 1, 0, 'C', true);
      ...
      //  $this->Cell(45, 5, utf8_decode($funcionario['grado']), 1, 0, 'C', true);
        ...
        //$this->Cell(20, 5, utf8_decode($funcionario['fecha_ingreso_nombra']), 1, 0, 'C', true);
		 $this->Cell(40, 5, utf8_decode($funcionario['nivel_educativo']), 1, 0, 'C', true);
  ...
  // $pdf->tableTotales();
  $pdf->SetFont('Arial', '', 8);
  $name_file = 'funcionariosNivelEducativo.pdf';
