...
if (true) {
  ...
  if (!empty($_GET['edad_ini']) && !empty($_GET['edad_fin']))
    $data = generalesMD::Funcionario_edad($_GET['edad_ini'], $_GET['edad_fin']);
  ...
  $name_file = 'funcionarios' . $_GET['edad_ini'] . '_' . $_GET['edad_fin'] . '.pdf';
