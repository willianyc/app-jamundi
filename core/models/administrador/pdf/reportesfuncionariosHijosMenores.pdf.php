...
if (true) {
  ...
  $data = generalesMD::getFuncionarioHijosMenores($_GET['fecha_ini'], $_GET['fecha_fin']);
...
//$this->Ln();
     ...
     // $this->Cell(1170, 5, utf8_encode('Reporte de Funcionarios por Fechas de ingreso entre : '. $_GET['fecha_ini'] .' y '. $_GET['fecha_fin']), 1, 0, 'C', true);
       $this->Cell(280, 10, utf8_encode('REPORTE DE FUNCIONARIOS CON HIJOS MENORES DE EDAD ENTRE LAS FECHAS: '. $_GET['fecha_ini'] .' Y '. $_GET['fecha_fin']), 1, 0, 'C', true);
	  $this->Ln();
     ...
     // $this->Cell(45, 5, utf8_decode('TIPO VINCULACIÓN'), 1, 0, 'C', true);
      ...
      $this->Cell(35, 5, utf8_decode('NOMBRE HIJO'), 1, 0, 'C', true);
      $this->Cell(25, 5, utf8_decode('NACIMIENTO'), 1, 0, 'C', true);
     ...
     // $this->Cell(45, 5, utf8_decode('PROFESION'), 1, 0, 'C', true);
	  ...
	  $this->SetFillColor(255, 255, 255);
       ...
       // $this->Cell(45, 5, utf8_decode($funcionario['tipo_vinculacion']), 1, 0, 'C', true);
        ...
        $this->Cell(35, 5, utf8_decode($funcionario['nombre_hijo']), 1, 0, 'C', true);
        $this->Cell(25, 5, utf8_decode($funcionario['nacimiento_hijo']), 1, 0, 'C', true);
        //$this->Cell(20, 5, utf8_decode($funcionario['fecha_ingreso_nombra']), 1, 0, 'C', true);
		 $this->Cell(20, 5, utf8_decode($funcionario['edad_hijo']), 1, 0, 'C', true);
  ...
  // $pdf->tableTotales();
  $pdf->SetFont('Arial', '', 8);
  $name_file = 'FuncionarioHijosMenores.pdf';
