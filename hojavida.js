...
$(document).ready(function () {
  ...
  $(document).on("click", "button[name=eliminarDetalle]", function () {
    ...
    eli_fam = confirm("Esta seguro que quiere eliminar a este faemiliar");
    ...
    .done(function (data) {
      if (data.trim() !== "") {
        ...
        $("#exp_general").val(valor_gen);
          ...
          <td class="td-table"><input type="text" class="form-control input-table desactivar" name="nombre" value="${
            this.nombres
          }" placeholder="Nombres..." disabled required=""></td>
          <td class="td-table"><input type="text" class="form-control input-table desactivar" name="apellido" value="${
            this.apellidos
          }" placeholder="Apellidos..." disabled required=""></td>
          <td class="td-table">
            <select class="form-control input-table parentesco desactivar" disabled name="parentesco" placeholder='Parentesco...' required="">
              ${parentesco}
            </select>
          </td>
          <td class="td-table"><input type="text" class="form-control input-table" name="parentesco_otro" disabled placeholder="Parentesco..."></td>
          <td>
            <input type="date" class="form-control input-table desactivar" name="fecha_nacimiento" disabled required="">
          </td>
          <td class="td-table"><input type="number" disabled class="form-control input-table desactivar" name="edad" value="${
            this.edad
          }" placeholder="Edad..." required=""></td>
          <td class="td-table" style="text-align: center;">
            <input type="checkbox" style="width: 21px;height: 21px;" name="emegencia" ${
              this.is_emergencia == 1 ? "checked" : ""
            } class="form-check-input desactivar emergencia_check" disabled>
          </td>
          <td class="td-table" style="text-align: center;">
          ...
          <td>
            ...
            $("#tblNucleoFamiliar tbody select[name=parentesco]").val(
              this.id_parentesco
            );
...
function addDetall() {
  ...
  var fila = `<tr class='nucleo_familia'>
              ...
              <td class="td-table"><input type="text" class="form-control input-table" name="parentesco_otro" disabled placeholder="Parentesco..."></td>
              <td>
                <input type="date" class="form-control input-table" required name="fecha_nacimiento">
              </td>
...
function GuardarFuncionario() {
  ...
  fecha_proceso =
    $("#fecha_proceso").val() == "" ? null : $("#fecha_proceso").val();
  data = new FormData();
