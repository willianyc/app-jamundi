...
<script type="text/javascript" src="views/js/administrador/datos/asignacionFuncionariosCapacitacionesProgramadas.js"></script>
...
<div class="row">
    ...
    <form action="" class="mb-3">
        ...
        <div class="col-md-12 mb-2 hidden-info">
            ...
            <div class="secciones">
				...
				<div class="col-md-4 mb-2">
                            ...
                            <select class="form-control color-t selectpicker" disabled id="grupoObjetivo" multiple required="" data-live-search="true">
                                <option value="" selected disabled>Seleccione...</option>
                            </select>
                            <input type="text" class="form-control input-form color-t border-required" id="grupoObjetivo" required="" name="grupoObjetivo" placeholder="Grupo objetivo...">
                            <div class="invalid-feedback">
				...
				-->
                        ...
                        <div class="col-md-6 mb-2">
                            <label class="label-form" for="entidad">Responsable de la capacitacion <span style="color: red;">*</span></label>
                            <input type="text" class="form-control input-form color-t border-required" id="entidad" required="" name="entidad" placeholder="Responsable de la capacitacion...">
                            <div class="invalid-feedback">
                                Debe ingresar el Responsable de la capacitacion
                            </div>
                        </div>
                        ...
                        <table class="table table-striped" id="tblAsignarFuncionarios">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><input type="checkbox" disabled name="asistioAll"></th>
                                </tr>
        ...
        <div class="col-md-12 mb-2 trazabilidad table-responsive d-none">
            <table class="table table-striped" id="trazabilidadCapacitacionesProgramadas">
                <thead>
                    <tr>
