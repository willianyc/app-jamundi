...
<script type="text/javascript" src="views/js/administrador/datos/asignacionFuncionariosCapacitacion.js"></script>
                ...
                <table class="table table-striped" id="tbl_funcionarios" style="display: block;overflow: auto;height: 350px;">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="searchByDependencia" class="form-control" placeholder="Dependencia..."></td>
...
<h5>DETALLES DE LA CAPACITACIÓN</h5>
<hr class="mb-1">
<div class="row">
  ...
  <form action="" class="mb-3">
    <div class="row">
      <div class="col-md-12 mb-2">
        <button class="btn btn-otros m-1" id="btnEliminarCapacitacion" style="float:right" type="button"> <i class="fa fa-trash-o"></i> ELIMINAR</button>
    ...
    <div class="row show-info-traz d-none">
            <div class="col-md-12 mb-2">
            <h6 class="submenus">Datos de la capacitacion</h6>
                <div class="secciones">
    ...
    <div class="col-md-12 mb-2 hidden-info">
      ...
      <input type="hidden" id="id_capacitacion">
      <div class="secciones">
        <div class="row padding-secciones">
          <div class="row">
            <div class="col-md-4 mb-2">
              <label class="label-form" for="identificacion">Identificación</label>
              <input type="text" class="form-control input-form color-t border-required" id="identificacion" name="identificacion" required="" placeholder="Identificacion...">
              <div class="invalid-feedback">
                Debe ingresar la Identificación
              </div>
            </div>
            <div class="col-md-3">
              <label for="calificacion" class="label-form">Calificación</label>
            ...
            <div class="col-md-5 mb-2">
              ...
              <input type="text" class="form-control input-form color-t border-required" id="nombre" name="nombre" required="" placeholder="Nombre...">
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-4 mb-2">
              ...
              <input type="date" class="form-control input-form color-t disabled border-required" id="fecha_inicio">
              <div class="invalid-feedback">Debe seleccionar la fecha.</div>
            </div>
            <div class="col-md-4 mb-2">
              <label for="fecha_finalizacion" class="label-form">Fecha de finalización</label>
              <input type="date" class="form-control input-form color-t disabled border-required" id="fecha_finalizacion">
              <div class="invalid-feedback">Debe seleccionar la fecha.</div>
            </div>
            <div class="col-md-4 mb-2">
              <label class="label-form" for="modalidad">Modalidad</label>
          ...
          <div class="row">
            <div class="col-md-6 mb-2">
              <label class="label-form" for="direccion">Lugar</label>
              <input type="text" class="form-control input-form color-t border-required" id="direccion" name="direccion" required="" placeholder="Lugar...">
              <div class="invalid-feedback">
                Debe ingresar el Lugar
              </div>
            </div>
            <div class="col-md-6 mb-2">
              <label class="label-form" for="horas_formativas">Intensidad horaria</label>
              <input type="text" class="form-control input-form color-t border-required" id="horas_formativas" name="horas_formativas" required="" placeholder="Intensidad horaria...">
              <div class="invalid-feedback">
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-2">
              <label class="label-form" for="conocimiento_previo">Descripción</label>
              <textarea type="text" class="form-control input-form color-t border-required" id="conocimiento_previo" name="conocimiento_previo" required="" placeholder="Descripción..."></textarea>
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-6 mb-2">
              ...
              <input type="text" disabled class="form-control input-form color-t border-required" id="entidadCapacitadora" name="entidadCapacitadora" required="" placeholder="Entidad capacitadora...">
              <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-2">
              ...
              <input type="file" accept="application/pdf" class="form-control input-form color-t border-required" disabled id="archivo" name="archivo" placeholder="Adjuntar archivo...">
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-6 mb-2" id="divEstado">
            ...
            <div class="col-md-6 mb-2">
              <label class="label-form" for="motivo">Cantidad</label>
              <input type="number" class="form-control input-form color-t border-required" id="cantidadid" disabled name="cantidad" required="" placeholder="Cantidad...">
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-12 mb-2" id="divMotivo" style="display: none;">
              ...
              <textarea type="text" class="form-control input-form color-t border-required" disabled id="motivo" name="motivo" placeholder="Motivo..."></textarea>
              <div class="invalid-feedback">
          ...
          <div class="row" id="trazabilidadData" style="display: none;">
            <div class="col-md-12">
              <label class="label-form" for="observacion">Observación Capacitación</label>
              <textarea type="text" class="form-control input-form" id="observacion" name="observacion" placeholder="Observación..."></textarea>
              <div class="invalid-feedback">
    ...
    <div class="col-md-12 mb-2" id="listaFUncionariosAsignados" style="display: none;">
      <h6 class="submenus">LISTA DE FUNCIONARIOS ASIGNADOS</h6>
      <input type="hidden" id="id_seguridadsocial">
      <div class="secciones">
        <div class="row padding-secciones">
          <div class="form-row">
            <div class="col-md-6">
              <input class="form-control input-form color-t" id="filterTable" type="text" placeholder="Buscar funcionarios..">
              <button type="button" style="display: none;" id="btnBuscarFuncionariosUpdate" class="btn btn-otros" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-user"></i> ASIGNAR FUNCIONARIO</button>
            </div>
            <br>
        ...
        <div class="row padding-secciones">
          ...
          <div class="form-row table-responsive">
            <table class="table table-striped" id="tblAsignarFuncionarios">
              <thead>
                <tr>
                  <th colspan="10" style="text-align:center;background-color:#e6e6e6">FUNCIONARIOS ASIGNADOS</th>
                </tr>
                <tr>
                  <th scope="col">Identificación</th>
                  <th scope="col">Nombre</th>
    ...
    <div class="col-md-12 mb-2 hidden-info">
      <button class="btn color-button" id="btnGuardar" disabled style="float:right" type="button"> <i class="fa fa-save"></i> GUARDAR</button>
    </div>

        <div class="col-md-12 mb-2 trazabilidad table-responsive d-none">
            <table class="table table-striped" id="asignacionFuncionariosCapacitaciones">
                <thead>
                    <tr>
                        <th colspan="6" style="text-align:center; background-color:#e6e6e6;">TRAZABILIDAD CAPACITACIÓN PROGRAMADA</th>
                    </tr>
                    <tr>
                        <th scope="col">
                            Fecha actualización
