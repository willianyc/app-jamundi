...
<script type="text/javascript" src="views/js/administrador/datos/asignacionFUncionariosActividad.js"></script>
...
<div class="row">
  ...
  <form action="" class="mb-3">
      ...
      <div class="secciones">
        <div class="row padding-secciones">
          <div class="row">
            ...
            <div class="col-md-2">
              <label for="calificacion" class="label-form">Calificación <span style="color: red;">*</span></label>
          ...
          <div class="row">
            <div class="col-md-6 mb-2">
              <label class="label-form" for="entidad">Entidad que realiza la actividad <span style="color: red;">*</span></label>
              <input type="text" class="form-control input-form color-t border-required" id="entidad" required="" name="entidad" placeholder="Entidad que realiza la actividad...">
              <div class="invalid-feedback">
                Debe ingresar el Entidad que realiza la actividad
              </div>
            </div>
            <div class="col-md-6 mb-2">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-2" id="divMotivo" style="display: none;">
            ...
            <div class="col-md-6 mb-2">
              ...
              <input type="text" class="form-control input-form color-t border-required" id="cantidad" disabled name="cantidad" placeholder="Cantidad...">
              <div class="invalid-feedback">
            ...
            <div class="row d-none" id="divObservacion">
              <div class="col-md-12 mb-2">
                <label class="label-form" for="observacion">Observacion</label>
                <textarea name="observacion" id="observacion" class="form-control input-form" disabled placeholder="Observación"></textarea>
              </div>
            </div>
			      <div class="row">
              <div class="col-md-12 mb-2">
                <label class="label-form" for="descripcion">Descripción de la actividad <span style="color: red;">*</span></label>
                <input type="text" class="form-control input-form color-t border-required" id="descripcion" disabled required="" name="descripcion" placeholder="Descripción...">
                <div class="invalid-feedback">
    ...
    <div class="col-md-12 mb-2 trazabilidad table-responsive d-none">
            <table class="table table-striped" id="trazabilidadActividad">
                <thead>
                    <tr>
                        <th colspan="6" style="text-align:center; background-color:#e6e6e6;">TRAZABILIDAD ACTIVIDAD</th>
                    </tr>
                    <tr>
                        <th scope="col">
                            Fecha actualización
