...
<script type="text/javascript" src="views/js/administrador/datos/consultarActividadesProgramadas.js?v=<?php echo(rand()); ?>"></script>

<h5>CONSULTAR ACTIVIDADES PROGRAMADAS</h5>
<hr>
<div class="container mt-3">
    ...
    <table class="table table-striped" id="tblActividad">
        <thead>
            <tr>
                <th colspan="8" style="text-align:center;background-color:#e6e6e6"><span class="tituloTabla">ACTIVIDADES</span></th>
            </tr>
            <tr>
    ...
    <!-- Majjul -->
    <table class="table table-striped d-none" id="tblActvidadesReportes">
        <thead>
            <tr>
             <th colspan="8" style="text-align:center;background-color:#e6e6e6">
                <div class="d-flex justify-content-between">
                <div>REPORTE DE ACTIVADES PROGRAMADAS POR ESTADO</div>
                <div>
                    <select class="form-control input-form color-t" id="reporteEstado">
                        <option value="" disabled selected>Selecciones Estado a Filtrar ...</option>
