...
<script type="text/javascript" src="views/js/administrador/datos/consultarCapacitacionesProgramadas.js?v=<?php echo(rand()); ?>"></script>

<h5>CONSULTAR CAPACITACIONES 3</h5>
<hr>
<div class="container mt-3">
    ...
    <table class="table table-striped" id="tblActividad">
        <thead>
            <tr>
                <th colspan="8" style="text-align:center;background-color:#e6e6e6">CAPACITACIONES</th>
            </tr>
            <tr>
    ...
    <!-- Majjul -->
    <table class="table table-striped d-none" id="tblCapacitacionesReportes">
        <thead>
            <tr>
