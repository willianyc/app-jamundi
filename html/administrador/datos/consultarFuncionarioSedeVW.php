  ...
  <div class="row">
    <div class="col-md-12 row">
      <div class="col-md-6 row">
        <div class="col-md-6">
          <label for="">Funcionarios por sede</label>
          <select class="form-control input-form color-t border-required desactivar" id="sede" placeholder='Nivel educativo...' required="">
          </select>
        </div>
      </div>
      <div class="col-md-4">
...
<script type="text/javascript" src="views/js/administrador/datos/consultarfuncionariosede.js"></script>