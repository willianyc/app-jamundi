    ...
    <div class="col-md-12 row">
      <div class="col-md-6 row">
        <div class="col-md-6">
          ...
          <input class="form-control input-form color-t" id="edad_ini" type="number" placeholder="Buscar..">
        </div>
        <div class="col-md-6">
          <label>Edad final</label>
          <input class="form-control input-form color-t" id="edad_fin" type="number" placeholder="Buscar..">
        </div>
      </div>
      <div class="col-md-4">
...
<script type="text/javascript" src="views/js/administrador/datos/consultarfuncionariosEdad.js"></script>