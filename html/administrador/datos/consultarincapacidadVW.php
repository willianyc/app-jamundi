<h5>INCAPACIDAD DE FUNCIONARIOS</h5>
<hr>
<div class="container mt-3">
  ...
  <table class="table table-striped" id="tblCapacitaciones">
    <thead>
      <tr>
        <th colspan="10" style="text-align:center;background-color:#e6e6e6">INCAPACIDAD DE FUNCIONARIOS</th>
      </tr>
      <tr>
...
<script type="text/javascript" src="views/js/administrador/datos/consultarincapacidad.js"></script>