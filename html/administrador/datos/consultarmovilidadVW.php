<h5>CONSULTAR MOVILIDAD DEL FUNCIONARIOS</h5>
<hr>
<div class="container mt-3">
  ...
  <table class="table table-striped" id="tblCapacitaciones">
    <thead>
      <tr>
        <th colspan="8" style="text-align:center;background-color:#e6e6e6">MOVILIDAD DEL FUNCIONARIOS</th>
      </tr>
      <tr>
        ...
        <th scope="col">Denominación de empleo</th>
...
<script type="text/javascript" src="views/js/administrador/datos/consultarmovilidad.js"></script>