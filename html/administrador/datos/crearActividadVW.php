...
<script type="text/javascript" src="views/js/administrador/datos/actividad.js?v=<?php echo(rand()); ?>"></script>
          ...
          <div class="row">
            <div class="col-md-6 mb-2">
			 ...
			 <div class="col-md-6 mb-2">
              ...
              <input type="text" class="form-control input-form color-t border-required" id="descripcion" required="" name="descripcion" placeholder="Descripción...">
              <div class="invalid-feedback">
