...
<script type="text/javascript" src="views/js/administrador/datos/inspeccion.js"></script>
...
<div class="row">
    ...
    <form action="" class="mb-3">
        <div class="col-md-12 mb-2">
            <h6 class="submenus">Crear Inspección</h6>
                ...
                <div class="row padding-secciones">
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" class="form-control input-form color-t border-required" disabled id="identificacion" required="" name="identificacion" placeholder="Identificacion...">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2 contentSedeDenominacion" style="display: block;">
