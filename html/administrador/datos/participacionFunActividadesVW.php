...
<script type="text/javascript" src="views/js/administrador/datos/participacionenActividades.js"></script>

<h5>FUNCIONARIOS QUE PARTICIPARÓN EN ACTIVIDADES</h5>
<hr>
<div class="container mt-3">
  ...
  <table class="table table-striped" id="tblRankinCapacitaciones">
    <thead>
      <tr>
        <th colspan="8" style="text-align:center;background-color:#e6e6e6">PARTICIPACION DE FUNCIONARIOS</th>
      </tr>
      <tr>
