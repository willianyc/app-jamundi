...
<script type="text/javascript" src="views/js/administrador/datos/rankingFuncionariosActividad.js"></script>

<h5>RANKING DE ACTIVIDADES</h5>
<hr>
<div class="container mt-3">
 <div class="row">
    ...
    <table class="table table-striped" id="tblRankinCapacitaciones">
        <thead>
            <tr>
                <th colspan="8" style="text-align:center;background-color:#e6e6e6">RANKING DE FUNCIONARIOS DE PARTICIPACION EN ACTIVIDADES</th>
            </tr>
            <tr>
